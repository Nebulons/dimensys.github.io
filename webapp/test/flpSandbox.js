		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#AssetPerformance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AssetPerformance-display": {
								"semanticObject": "AssetPerformance",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=be.dimensys.assetperformance.assetperformance",
									"url": sap.ui.require.toUrl("be/dimensys/assetperformance/assetperformance")
								}
							}
						}
					}
